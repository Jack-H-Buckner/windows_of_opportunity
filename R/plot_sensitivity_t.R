...
df <- read_csv("data/sensitivity_t.csv", show_col_types = FALSE)
...
ggsave("figures/sensitivity_t.png", fig, dpi = 400, width = 7, height = 4)
cat("Saved figures/sensitivity_t.png\n")
